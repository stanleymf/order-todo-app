...
import { Permission } from '../types/multi-tenant';
...
export function PermissionBasedRoute({ children, permissions, fallback }: PermissionBasedRouteProps) {
  const { user, loading } = useAuth();
...
export function StoreRequiredRoute({ children, fallback }: { children: ReactNode; fallback?: ReactNode }) {
...
export function OwnerOnlyRoute({ children, fallback }: { children: ReactNode; fallback?: ReactNode }) {
  return (
...
export function FloristOnlyRoute({ children, fallback }: { children: ReactNode; fallback?: ReactNode }) {
  return (
...
export function OrdersManagementRoute({ children, fallback }: { children: ReactNode; fallback?: ReactNode }) {
  return (
    <ProtectedRoute 
...
export function ProductsManagementRoute({ children, fallback }: { children: ReactNode; fallback?: ReactNode }) {
  return (
    <ProtectedRoute 
...
export function AnalyticsRoute({ children, fallback }: { children: ReactNode; fallback?: ReactNode }) {
  return (
    <ProtectedRoute 
...
export function SettingsRoute({ children, fallback }: { children: ReactNode; fallback?: ReactNode }) {
  return (
    <ProtectedRoute 
